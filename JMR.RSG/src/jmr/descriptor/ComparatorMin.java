...
/**
 * Clase para la creación del comparador Minimo.
 * 
 * @author Ramón Sánchez García (chentaco@correo.ugr.es)
 */
public class ComparatorMin implements Comparator<SegmentedDescriptor, Double>, Serializable {
    
    boolean position;

    /**
     * Constructor de la clase de comparador medio.
     * @param position variable booleana para tomar en cuenta la posición
     * de la región o no.
     */    
    public ComparatorMin(boolean position){
        super();
     ...
     * descriptores segmentados en función del minimo.
...
//                    System.out.println("r1: " + i + " r2: " + j + " bestvalue: " + (Double) m1.compare(m2));
