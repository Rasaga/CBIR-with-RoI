...
/**
 * Clase para la creación del comparador Media sin repeticiones.
 * 
 * @author Ramón Sánchez García (chentaco@correo.ugr.es)
 */
public class ComparatorAvgNoDuples implements Comparator<SegmentedDescriptor, Double> {
    
    boolean position;
    
    /**
     * Constructor de la clase de comparador medio sin repeticiones.
     * @param position variable booleana para tomar en cuenta la posición
     * de la región o no.
     */    
    public ComparatorAvgNoDuples(boolean position){
        super();
     ...
     * descriptores segmentados en función de la media y que no haya repeticiones.
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            clon1.remove(r1);
            clon2.remove(r2);
            // 4º. Aumento el numero total de valores para hacer la media, idem con el de usados
            total+=minAbsoluto;
            totalUsados++;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////            
        ...
        return (Double) (total / totalUsados);
    }
