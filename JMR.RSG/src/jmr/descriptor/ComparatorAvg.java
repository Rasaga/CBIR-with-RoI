...
/**
 * Clase para la creación del comparador Media.
 * 
 * @author Ramón Sánchez García (chentaco@correo.ugr.es)
 */

public class ComparatorAvg implements Comparator<SegmentedDescriptor, Double> {
     ...
     * de la región o no.
     */
    public ComparatorAvg(boolean position) {
        super();
     ...
     * descriptores segmentados en función de la media.
...
//                                System.out.println("Punto 1: " + p1.toString() + " Punto 2: " + p2.toString());
        ...
        avgFinal = total / t.getDescriptorList().size();
        return avgFinal;
    }
